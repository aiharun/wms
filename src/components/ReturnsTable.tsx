                    ...
                    <div className="relative w-full max-w-2xl bg-white rounded-[3rem] shadow-2xl overflow-hidden animate-scale-up flex flex-col max-h-[90vh]">
                        ...
                        <div className="p-8 border-b border-zinc-100 flex items-center justify-between bg-zinc-50/50">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-black text-zinc-900">İade Süreç Takibi</h3>
                        ...
                        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar space-y-8">
                            {isLoadingDetail ? (
                                <div className="py-20 flex flex-col items-center justify-center space-y-4">
                                    ...
                                    <p className="text-sm font-bold text-zinc-400 uppercase tracking-widest">Detaylar Çekiliyor...</p>
                                </div>
                            ) : (
                                <>
                                    {/* Products Summary */}
