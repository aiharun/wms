                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-zinc-50/50 border-b border-zinc-100">
                                ...
                                <th className="px-6 py-5 text-[10px] font-black text-zinc-400 uppercase tracking-widest">İade Sebebi</th>
                                <th className="px-6 py-5 text-[10px] font-black text-zinc-400 uppercase tracking-widest">Durum</th>
                        ...
                        <tbody className="divide-y divide-zinc-50">
                            {orders.map((order) => {
                                // Enhanced reason discovery for Trendyol List API
                                ...
                                return (
                                    <tr key={order.orderNumber} className="hover:bg-zinc-50/30 transition-colors group">
                                        <td className="px-6 py-4">
                                            <span className="text-sm font-mono font-bold text-rose-600">#{order.orderNumber}</span>
                                        </td>
                                        <td className="px-6 py-4">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="max-w-[200px]">
                                                <p className="text-xs font-medium text-zinc-500 line-clamp-2" title={returnReason}>
                                                    {returnReason}
                                                </p>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-4">
                                            <button
                                                ...
                                                className="mx-auto flex items-center justify-center w-8 h-8 rounded-lg text-zinc-400 hover:text-rose-600 hover:bg-rose-50 transition-all active:scale-90"
                                            >
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-black text-zinc-900 line-clamp-1">
                                        {viewMode === 'history' ? 'İade Süreç Takibi' : 'Canlı Kargo Takibi'}
                                    </h3>
                                    <p className="text-xs text-zinc-400 font-bold uppercase tracking-widest">
                                        Sipariş No: <span className="text-rose-600 font-mono">#{selectedOrder.orderNumber}</span>
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex bg-zinc-100 p-1 rounded-2xl mr-2">
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                viewMode === 'history' ? "bg-white text-rose-600 shadow-sm" : "text-zinc-500 hover:text-zinc-700"
                                            )}
                                        >
                                            Veriler
                                        </button>
                                        <button
                                            ...
                                            className={cn(
                                                "px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all",
                                                viewMode === 'tracking' ? "bg-white text-rose-600 shadow-sm" : "text-zinc-500 hover:text-zinc-700"
                                            )}
                                        >
                                            Canlı
                                        </button>
                                                        ...
                                                        return (
                                                            <div key={idx} className="relative">
                                                                <div className={cn(
                                                                    ...
                                                                    idx === historyArr.length - 1 ? "bg-rose-500 shadow-lg shadow-rose-500/30" : "bg-zinc-200"
                                                                )}>
                                                                ...
                                                                <div className="flex flex-col gap-1">
                                                                    <div className="flex items-center justify-between">
                                                                        <span className={cn(
                                                                            ...
                                                                            idx === historyArr.length - 1 ? "text-rose-600" : "text-zinc-600"
                                                                        )}>
                                        ...
                                        <>
                                            ...
                                            <div className="absolute bottom-4 right-4 group">
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    className="flex items-center gap-2 px-4 py-2 bg-white/90 backdrop-blur border border-zinc-200 rounded-xl text-[10px] font-black text-zinc-500 uppercase tracking-widest hover:text-rose-600 transition-all shadow-xl"
                                                >
