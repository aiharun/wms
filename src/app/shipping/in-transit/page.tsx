...
export default async function InTransitPage() {
    // Fetch orders with Shipped status
        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-zinc-900 leading-tight">Yolda Olanlar</h1>
                        <p className="text-zinc-500 font-medium tracking-tight">Kargoya verilmiş, ulaşmayı bekleyen paketler</p>
                    </div>
                </div>
            </div>
            ...
            {!error && orders.length === 0 && (
                <div className="text-center py-20 bg-white rounded-[3rem] border-2 border-dashed border-zinc-100">
                    <div className="w-24 h-24 rounded-full bg-zinc-50 flex items-center justify-center mx-auto mb-4 border-2 border-dashed border-zinc-200">
                        <Truck className="w-12 h-12 text-zinc-200" />
                    </div>
